...
export const ChevronLeft = ({ className }) => {
  return (
    <svg className={`w-[2rem] h-[2rem] text-gray-800 dark:text-white ${className}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 8 14">
      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.3" d="M7 1 1.3 6.326a.91.91 0 0 0 0 1.348L7 13" />
    </svg>
  );
};
...
export const ChevronRight = ({ className }) => {
  return (
    <svg className={`w-[2rem] h-[2rem] text-gray-800 dark:text-white ${className}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 8 14">
      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.3" d="m1 13 5.7-5.326a.909.909 0 0 0 0-1.348L1 1" />
    </svg>
  );
};

export const LoadingCircle = ({ ...rest }) => {
  return (
    <svg className="animate-spin -ml-1 mr-3 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" {...rest} >
        <circle className="opacity-25 stroke-black dark:stroke-white" cx="12" cy="12" r="10" strokeWidth="4" ></circle>
        <path className="opacity-75 fill-black dark:fill-white"
              d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 4.418 3.582 8 8 8v-4.709zM17.291 6A7.965 7.965 0 0120 12h4c0-4.418-3.582-8-8-8v4.709L17.291 6z" ></path>
    </svg>
  );
};
