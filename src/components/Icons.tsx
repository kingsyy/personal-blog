...
export const ChevronLeft = ({ className = "" }) => {
  return (
    <svg className={`w-[2rem] h-[2rem] text-gray-800 dark:text-white ${className}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 8 14">
      <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.3" d="M7 1 1.3 6.326a.91.91 0 0 0 0 1.348L7 13" />
    </svg>
  );
};
...
export const ChevronRight = ({ className = "" }) => {
  return (
    <svg className={`w-[2rem] h-[2rem] text-gray-800 dark:text-white ${className}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 8 14">
      <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.3" d="m1 13 5.7-5.326a.909.909 0 0 0 0-1.348L1 1" />
    </svg>
  );
};
