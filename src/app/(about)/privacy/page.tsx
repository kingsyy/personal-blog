    ...
    <section className="w-full h-auto flex flex-col md:flex-row items-center justify-center text-dark dark:text-light pt-8 ">
      <div className="inline-block w-full h-full md:border-r-2 border-solid border-dark dark:border-light  px-5 xs:px-10 md:px-16 pb-8">
        ...
        <p>
          ...
          to it, still belong to Arthur van Rooijen.
        </p> <p>
          Arthur van Rooijen is committed to ensuring that the app is
          ...
          The Arthur's Blog app stores and processes personal data that
          ...
          that the Arthur's Blog app won’t work properly or at all.
        </p><p>
          You should be aware that there are certain things that
          Arthur van Rooijen will not take responsibility for. Certain
          functions of the app will require the app to have an active
          internet connection. The connection can be Wi-Fi or provided
          by your mobile network provider, but Arthur van Rooijen
          ...
          Along the same lines, Arthur van Rooijen cannot always take
          responsibility for the way you use the app i.e. You need to
          make sure that your device stays charged – if it runs out of
          battery and you can’t turn it on to avail the Service,
          Arthur van Rooijen cannot accept responsibility.
        </p> <p>
          With respect to Arthur van Rooijen’s responsibility for your
          use of the app, when you’re using the app, it’s important to
          bear in mind that although we endeavor to ensure that it is
          updated and correct at all times, we do rely on third parties
          to provide information to us so that we can make it available
          to you. Arthur van Rooijen accepts no liability for any
          ...
          using the app. Arthur van Rooijen does not promise that it
          ...
          These terms and conditions are effective as of 2023-10-25
        </p> <p><strong>Contact Us</strong></p> <p>
          If you have any questions or suggestions about my
          Terms and Conditions, do not hesitate to contact me
          at privacy.xzcpl@8shield.net.
        </p> <p>This Terms and Conditions page was generated by <a href="https://app-privacy-policy-generator.nisrulz.com/" target="_blank" rel="noopener noreferrer">App Privacy Policy Generator</a></p>
      </div>
      <div className="w-full flex flex-col items-start justify-center px-5 xs:px-10 md:px-16 pb-8">
        <h2 className="font-bold capitalize  text-2xl xs:text-3xl sm:text-4xl">Privacy Policy</h2>
        <p>
          Arthur van Rooijen built the Arthur's Blog app as
          a Free app. This SERVICE is provided by
          Arthur van Rooijen at no cost and is intended for use as
          is.
        </p> <p>
          ...
          Arthur's Blog unless otherwise defined in this Privacy Policy.
        </p> <p><strong>Information Collection and Use</strong></p> <p>
          For a better experience, while using our Service, I
          may require you to provide us with certain personally
          identifiable information, including but not limited to Full name, Email, Phone number, Location. The information that
        ...
        <div><p>
          ...
          this page.
        </p> <p>This policy is effective as of 2023-10-25</p> <p><strong>Contact Us</strong></p> <p>
          If you have any questions or suggestions about my
          Privacy Policy, do not hesitate to contact me at privacy.xzcpl@8shield.net.
